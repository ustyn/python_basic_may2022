...
def write_user_to_file(users, search_name):
    ...
    with open(f'../lesson_9/{new_filename}.txt', 'w') as txt_write:
        json.dump(found, txt_write)
...
if __name__ == '__main__':
    ...
    task5 = write_user_to_file(users, 'Terry')
    print(f'file {task5} was created')
